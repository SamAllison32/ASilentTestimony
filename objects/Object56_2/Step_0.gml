...
/// @DnDArgument : "expr_4" ""Software used - Gamemaker Studio 2, FL Studio, Limelight Font, Photoshop, Piskel, Discord, Voice Memo""
/// @DnDArgument : "expr_5" ""Special thanks to Five Towns College.""
/// @DnDArgument : "var" "obj_text.text[0]"
/// @DnDArgument : "var_1" "obj_text.text[1]"
/// @DnDArgument : "var_2" "obj_text.text[2]"
/// @DnDArgument : "var_3" "obj_text.text[3]"
/// @DnDArgument : "var_4" "obj_text.text[4]"
/// @DnDArgument : "var_5" "obj_text.text[5]"
obj_text.text[0] = "Burke - Enemy logic, dialogue box, final boss sprite, hurt sfx, tilemaps, Level 2.";
...
obj_text.text[4] = "Software used - Gamemaker Studio 2, FL Studio, Limelight Font, Photoshop, Piskel, Discord, Voice Memo";
